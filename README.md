...
Sitio web e-commerce y catálogo digital exclusivo para la boutique **FRANCELLA COLLECTION**.
...
- **Catálogo de Moda Completo:**
  ...
  - Sección de ofertas exclusivas y promociones de carpa.
  - Vista rápida modal interactiva con selección de tallas y colores.
  - Carrito de compras y lista de deseos dinámicos en el front-end.
- **Enlaces Directos a Redes Sociales:**
  - [Instagram @francella.mx](https://www.instagram.com/francella.mx?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==)
  - [Facebook @francella.mx](https://www.facebook.com/francella.mx)
  - Canal de atención personalizada por WhatsApp.
...
├── js/
│   └── main.js          # Controladores de UI, audio, modales y carrito
├── index.html           # Página principal boutique
├── .gitignore
└── README.md
```

---
*Desarrollado para Francella Collection & Arcano Solutions.*
